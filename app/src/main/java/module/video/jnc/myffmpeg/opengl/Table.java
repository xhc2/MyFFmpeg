...
public class Table {
    ...
    public void bindData(TextureShaderProgram textureProgram){
        vertextArray.setVertexAttribPointer(0 , textureProgram.getPositionAttributeLocation() , POSITION_COMPONENT_COUNT , STRIDE);
        vertextArray.setVertexAttribPointer(POSITION_COMPONENT_COUNT ,textureProgram.getTextureCoordinatesAttributeLocation(), TEXTURE_COORDINATES_COMPONNET_COUNT , STRIDE);
    }
