 ...
 * http://www.iqiyi.com/playlist442489402.html ffmpeg 视频教程
 * https://www.bilibili.com/video/av11321658/ opengl教学视频
...
//        textView.setText(FFmpegUtils.stringJni());
        ...
        findViewById(R.id.camera_filter).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainActivity.this,  MyCameraFilter.class));
            }
        });
